...
def g():
    ...
    # print(y_pred)
    offset = 3
    survivor = y_pred[y_pred.size - offset]
    url = "https://raw.githubusercontent.com/DavidKrugerT/images/main/" + str(survivor) + ".png"
    print("Survivor predicted: " + str(survivor))
    ...
    print(label)
    label_url = "https://raw.githubusercontent.com/DavidKrugerT/images/main/" + str(int(label)) + ".png"
    print("Survivor actual: " + str(label))
    ...
    print("titanic predictions: " + str(predictions.value_counts().count()))
    if predictions.value_counts().count() == 2:
        ...
        print("You need 2 different survivor predictions to create the confusion matrix.")
        print("Run the batch inference pipeline more times until you get 2 different titanic survivor predictions")
